...
class API {
	 ...
	 */
	static async rollCompendiumAsRolltable(compendium = null) {
	 ...
	 */
	static async createRolltableFromCompendium(compendiumName, tableName = compendiumName + ' RollTable', { weightPredicate = null } = {}) {
