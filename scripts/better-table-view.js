...
export class BetterRT {
    ...
    static preUpdateRollTable(tableEntity, updateData, diff, tableId) {
        ...
        let arr = { "better-rolltables": {}},
            ...
            json_data = JSON.parse(tableEntity.getFlag(BRTCONFIG.NAMESPACE, 'json'));
        arr[BRTCONFIG.NAMESPACE][BRTCONFIG.TABLE_TYPE_KEY] = udf[BRTCONFIG.TABLE_TYPE_KEY] || json_data[BRTCONFIG.NAMESPACE][BRTCONFIG.TABLE_TYPE_KEY] || tableEntity.getFlag(BRTCONFIG.NAMESPACE,BRTCONFIG.TABLE_TYPE_KEY);
        arr[BRTCONFIG.NAMESPACE][BRTCONFIG.LOOT_CURRENCY_KEY] = udf[BRTCONFIG.LOOT_CURRENCY_KEY] || json_data[BRTCONFIG.NAMESPACE][BRTCONFIG.LOOT_CURRENCY_KEY] || tableEntity.getFlag(BRTCONFIG.NAMESPACE,BRTCONFIG.LOOT_CURRENCY_KEY);
        arr[BRTCONFIG.NAMESPACE][BRTCONFIG.ROLLS_AMOUNT_KEY] = udf[BRTCONFIG.ROLLS_AMOUNT_KEY] || json_data[BRTCONFIG.NAMESPACE][BRTCONFIG.ROLLS_AMOUNT_KEY] || tableEntity.getFlag(BRTCONFIG.NAMESPACE,BRTCONFIG.ROLLS_AMOUNT_KEY);
        arr[BRTCONFIG.NAMESPACE][BRTCONFIG.ACTOR_NAME_KEY] =  udf[BRTCONFIG.ACTOR_NAME_KEY] || json_data[BRTCONFIG.NAMESPACE][BRTCONFIG.ACTOR_NAME_KEY] || tableEntity.getFlag(BRTCONFIG.NAMESPACE,BRTCONFIG.ACTOR_NAME_KEY);
        arr[BRTCONFIG.NAMESPACE][BRTCONFIG.RESULTS_FORMULA_KEY] = udf[BRTCONFIG.RESULTS_FORMULA_KEY] || json_data[BRTCONFIG.NAMESPACE][BRTCONFIG.RESULTS_FORMULA_KEY] || tableEntity.getFlag(BRTCONFIG.NAMESPACE,BRTCONFIG.RESULTS_FORMULA_KEY);
